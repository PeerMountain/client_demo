...
public class UnitTests {
    ...
    public void testSerialization_ServiceRegistration_Pack() throws Exception{
    	ServiceRegistration a = new ServiceRegistration(
    	         ...
    	         new byte[0], 
    	         ArrayList<ServiceDocument>.asList(new ServiceDocument(new XForm(Arrays.asList("IdentityDocument")),
    	        		 		Arrays.asList(new ServiceAttestation(new Address("2n6HW4uS6Wqq8e4vgkQHnniCu3yrhvjHHHF"),
    	        		 	   ...
    	        		 	   new ServiceDocument(new XForm(Arrays.asList("Name", "Surname", "AddressLine1", "AddressLine2", "PostalCode",
	    	        		  					...
	    	        		  					Arrays.asList(new ServiceAttestation(Address("2n6HW4uS6Wqq8e4vgkQHnniCu3yrhvjHHHF"), 
